...
var hat:string:='                          Министерство науки  и высшего образования РФ'+#10+'             Федеральное государственное учреждение высшего образования'+#10+'"Рязанский государственный радиотехнический университет имени В.Ф.Уткина"';
//переменные игрока
const radPlayer = 20;
